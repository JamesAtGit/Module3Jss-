...
const collectEmployees = function() {
  ...
  while (adding) {
    ...
    let salary = parseFloat(prompt("Enter the employee's salary (numbers only):"));
...
addEmployeesBtn.addEventListener('click', trackEmployeeData);/ Get a reference to the #add-employees-btn element
const addEmployeesBtn = document.querySelector('#add-employees-btn');
